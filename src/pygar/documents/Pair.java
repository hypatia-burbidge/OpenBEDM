 ...
 * SimpleXmlMatcher.java. The file was broken when the Pair class was withdrawn.
 * We include this contributed file as a patch - but bear in mind that the Pair
 * class and SimpleXmlMatcher are deprecated for future development work.
 * @author pbaker
 * @param <A>
 * @param <B> 
 */
